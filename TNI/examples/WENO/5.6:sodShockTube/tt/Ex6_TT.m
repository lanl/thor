%% Info
% Example 5.6 : Sod Shock tube in tensor-train format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTWENOLIB=/path/of/WENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('Ex6_TT.m'); catch err, disp(getReport(err)); end;exit;"
...
C_eps     = 2;                                    % Empricial coefficient in Eq. (35) of the TT-WENO paper by Danis et al. 
