%% Info
% Example 5.2 : 3D Burgers' equation in full-tensor format with smooth solution
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTWENOLIB=/path/of/WENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('Ex2_FT.m'); catch err, disp(getReport(err)); end;exit;"
clear; clc; close all;
