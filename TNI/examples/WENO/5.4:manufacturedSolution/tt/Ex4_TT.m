%% Info
% Example 5.4 : Manufactured Solution in tensor-train format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTWENOLIB=/path/of/WENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('Ex4_TT.m'); catch err, disp(getReport(err)); end;exit;"
clear; clc; close all;
