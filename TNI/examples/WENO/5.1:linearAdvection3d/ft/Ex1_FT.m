%% Info
% Example 5.1 : 3D Linear Advection in full-tensor format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTWENOLIB=/path/of/WENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('Ex1_FT.m'); catch err, disp(getReport(err)); end;exit;"
clear; clc; close all;
...
%addpath(fdwenolib.ft+"/equations/LinearWave3d");
