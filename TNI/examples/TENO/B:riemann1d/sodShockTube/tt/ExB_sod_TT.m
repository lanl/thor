%% Info
% Example B   : Sod Shock tube in tensor-train format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTTENOLIB=/path/of/TENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('ExB_sod_TT.m'); catch err, disp(getReport(err)); end;exit;"
...
C_eps     = 2;                                    % Empricial coefficient in Eq. (35) of the TT-TENO paper by Danis et al. 
