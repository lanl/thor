...
% ReconChar: Flat to use characteristic decomposition (true or false)                %
...
% ---------------------------------------------------------------------------------- %
function data = ftFDTenoSolver(Tfinal, dtOption, CFL, Neq, Nx, Ny, Nz, Lx, Ly, Lz,...
                               F, Eig, Q0, BC, ReconChar, isSource, gam, isConsErr)
    %
    % Function Structure:
