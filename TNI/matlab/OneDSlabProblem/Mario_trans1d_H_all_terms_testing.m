...
sigt   = [ 2.3336e-01 2.3105e-01 3.0084e-01 2.8809e-01 3.8538e-01 ...
  5.0120e-01 6.1661e-01 7.8866e-01];
sigs   = load( './Data/sigma_s_8groups.txt' );
...
%%
L0  = kron( IG, kron( [ones(1,L)]*diag( wgt ), IM ) );
...
SigmaF = Z*SigmaF*S;
save('./Data/SigmaS.txt','SigmaS');
save('./Data/SigmaF.txt','SigmaF');
%%
Hbc  = ZB*B;

H = Hmu + Hsig + Hbc;
Href = Hmum + Hmup + Hsigp + Hsigm;
