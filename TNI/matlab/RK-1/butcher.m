...
elseif (strcmp(method_name,'Verner-6-5-ERKb'))
   A = [z, z , z, z, z, z,z,z;...
       v(1)/v(8), z , z, z, z, z, z, z ;...
       v(1)/v(18), v(1)/v(9), z, z, z, z, z, z ;...
       v(1)/v(16), z, v(3)/v(16), z, z, z, z, z ; ...
       v(1)/v(4), z , -v(3)/v(4), v(1), z, z,z,z;...
       v(134)/v(625), z , -v(333)/v(625), v(476)/v(625), v(98)/v(625), z,z,z;...
       -v(98)/v(1875), z , v(12)/v(625), v(10736)/v(13125), -v(1936)/v(1875),...
       v(22)/v(21),z,z;...
       v(9)/v(50), z , v(21)/v(25), -v(2924)/v(1925), v(74)/v(25), -v(15)/v(7)...
       ,v(15)/v(22),z];
   b = [v(11)/v(144), z, z, v(256)/v(693), z, v(125)/v(504), v(125)/v(528), v(5)/v(72)];
   c = [z; v(1)/v(8); v(1)/v(6); v(1)/v(4); v(1)/v(2); v(3)/v(5); v(4)/v(5); v(1)];
   q = 6; 
   B = [c,A;q,b];
