...
temp_1 = tt_Hy_value(xgrid+dx/2, ygrid, zgrid+dz/2, tm); %compute Hy_1 
temp_0 = tt_Hy_value(xgrid+dx/2, ygrid, zgrid+dz/2-dz, tm); %compute Hy_0 
...
temp_1 = tt_Hx_value(xgrid, ygrid+dy/2, zgrid+dz/2, tm); %compute Hz_1 
temp_0 = tt_Hx_value(xgrid, ygrid+dy/2, zgrid+dz/2-dz, tm); %compute Hz_0 
...
temp_1 = tt_Ez_value(xgrid,ygrid,zgrid+dz/2,te); %compute Ez_1
temp_0 = tt_Ez_value(xgrid,ygrid,zgrid+dz/2,te-dt); %compute Ez_0
tJz = round(temp_1-temp_0, tol)/dt;

temp_1 = tt_Hy_value(xgrid+dx/2, ygrid, zgrid+dz/2, tm); %compute Hy_1 
temp_0 = tt_Hy_value(xgrid+dx/2-dx, ygrid, zgrid+dz/2, tm); %compute Hy_0 
tJz = round(tJz - (temp_1-temp_0)/dx, tol);

temp_1 = tt_Hx_value(xgrid, ygrid+dy/2, zgrid+dz/2, tm); %compute Hx_1 
temp_0 = tt_Hx_value(xgrid, ygrid+dy/2-dy, zgrid+dz/2, tm); %compute Hx_0 
