function data=recon3GQideal(data)
    %
    % computes a third order reconstruction at the quadrature points over the cell volume in the TT format
    %
    weps = data.weno.weps;
    nq   = data.quad.n;
    % get size
