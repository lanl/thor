function [ttH, ttHf, ttHs, ttPsi1, k, convrate, Itertime] = tt_1DSlab_EVP_1groupfn(param, tol, savefilename)
...
ttHf = ttHs*(chi*nusigma_f)/sigma_s;

%% Fixed-point scheme in tensor train
% fixed point schemes
ttPsi0 = tt_ones([nx;nmu],2,1);
k = 1;
niter = param.niter;
