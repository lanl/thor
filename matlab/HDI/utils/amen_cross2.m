function [y,Y]=amen_cross2(inp, fun, tol, xgrid, varargin)
...
%   end
  ...
  if (norm(cry, 'fro')==0)
%     fprintf('The initial solution is exactly zero. Try a random initial guess\n');
    cry = rand(size(cry));
