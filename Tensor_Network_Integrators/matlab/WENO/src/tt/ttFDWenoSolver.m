...
% Purpose     : Tensor-Train Finite Difference Weighted Essentially                  %
...
% ---------------------------------------------------------------------------------- %
function data = ttFDWenoSolver(Tfinal, dtOption, CFL, Neq, Nx, Ny, Nz, Lx, Ly, Lz,...
                               F, Eig, Q0, BC, isSource, gam, ...
