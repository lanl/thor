classdef c_init < handle
    ...
    methods
        function [obj, status] = c_init(filename)
            % Constructor method
            ...
            if strcmp(probname, name_accelpiston)
                ...
                rho_ea_reg(1:nreg) = [0.0, 1.0, 8.96];
                ...
                if dim == 2
                    param_left(1:4) = [-50.0, 0.0, 0.0, 0.2];
                elseif dim == 3
                    param_left(1:6) = [-50.0, 0.0, 0.0, 0.0, 0.2, 0.2];
                end
                reg_shape(2) = region_shape(shape_type.shape_rectangular, param_left);
                
                if dim == 2
                    param_block(1:4) = [0.0, 0.0, 5.0, 0.2];
                elseif dim == 3
                    param_block(1:6) = [0.0, 0.0, 0.0, 5.0, 0.2, 0.2];
                end
            ...
            elseif strcmp(probname, name_sod)
                ...
                if dim == 2
                    ...
                    param_left(1:4) = [0.0, 0.0, 0.5, 0.2];
                elseif dim == 3
                    xl(1:3) = [0.0, 0.0, 0.0];
                    xr(1:3) = [1.0, 0.2, 0.2];
                    ncell(1:3) = [100, 20, 20];
                    
                    param_left(1:6) = [0.0, 0.0, 0.0, 0.5, 0.2, 0.2];
                end
                reg_shape(2) = region_shape(shape_type.shape_rectangular, param_left);
