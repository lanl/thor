...
{  
    ...
    if (dim == 2) { 
	    ...
	    k1 = k + 1;
            ...
            dvx = 0.25 * (
            (vel_3dnode[k ][j ][i1][0] + vel_3dnode[k ][j1][i1][0] +
            vel_3dnode[k1][j ][i1][0] + vel_3dnode[k1][j1][i1][0]) -
            (vel_3dnode[k ][j ][i ][0] + vel_3dnode[k ][j1][i ][0] +
            vel_3dnode[k1][j ][i ][0] + vel_3dnode[k1][j1][i ][0])
            );
...
//                     work = (pres_2dmat[j][i][m]/(rho_2dcell[j][i] + tiny)) * divu_2dcell[j][i] * dt; 
                     work = (pres_2dmat[j][i][m]/(rho_2dmat[j][i][m] + tiny)) * divu_2dcell[j][i] * dt;  
