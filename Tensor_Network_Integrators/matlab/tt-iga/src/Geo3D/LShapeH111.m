function [wn, ctpxn, ctpyn, ctpzn, knot1n, knot2n, knot3n] = LShapeH111(LL, HH, nn1, nn2, nn3)
%
n1 = 3; n2 = 2; n3 = 4;
...
ctpz(:,:,1) = zeros(n1, n2);
ctpz(:,:,2) = (HH/3)*ones(n1, n2);
ctpz(:,:,3) = (2*HH/3)*ones(n1, n2);
ctpz(:,:,4) = HH*ones(n1, n2);
...
[wn, ctpxn, ctpyn, ctpzn, knot3n]  = KnotInsertMW3_3D(wn, ctpxn, ctpyn, ctpzn, knot3, sref([nn3 nn3 nn3], ReduceKnotUnbound(knot3)));
