function [N3D, B3D, J] = GetB3D_3D(k1, k2, k3, xi1, xi2, xi3, we, pp1, pp2, pp3, ctpxe, ctpye, ctpze)
[N, DND1, DND2, DND3] = GetD1NURBS3Df(k1, k2, k3, xi1, xi2, xi3, pp1, pp2, pp3, we);
N3D = NtoN3(N);

B3D = zeros(6, 3*(pp1+1)*(pp2+1)*(pp3+1));
