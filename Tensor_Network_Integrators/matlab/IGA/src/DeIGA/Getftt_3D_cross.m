function Ftt = Getftt_3D_test(knot1n, knot2n, knot3n, ctpxn, ctpyn, ctpzn, ffunction, tt_tol)

%%
% [ftt] = Decomposef_3D(knot1n, knot2n, knot3n, ctpxn, ctpyn, ctpzn, ffunction, tt_tol);

ftt = Decomposef_3D_tt_cross(knot1n, knot2n, knot3n, ctpxn, ctpyn, ctpzn, ffunction, tt_tol);
%%
R1 = ftt.r(2);
R2 = ftt.r(3);
fprintf('f: rank = %d %d\n', R1, R2);
