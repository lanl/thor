%% Info
% Example C   : 2D Riemann problem (Configuration 11) in full-tensor format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTTENOLIB=/path/of/TENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('ExC_config_11_FT.m'); catch err, disp(getReport(err)); end;exit;"
