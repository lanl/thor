%% Info
% Example 5.10 : Inviscid Rayleigh-Taylor problem in full-tensor format
% Developer    : M. Engin Danis
% Notes        :
% It is recommended to run this script on terminal:
% (1) do: export TTWENOLIB=/path/of/WENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('Ex10_FT.m'); catch err, disp(getReport(err)); end;exit;"
