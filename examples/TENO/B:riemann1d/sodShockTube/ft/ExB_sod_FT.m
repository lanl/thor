%% Info
% Example B   : Sod Shock tube in full-tensor format
% Developer   : M. Engin Danis
% Notes       :
% It is recommended to run this script on terminal:
% (1) do: export TTTENOLIB=/path/of/TENO-paper
% (2) do: matlab -nodesktop -nojvm -nosplash -nodisplay -singleCompThread -r "try, run('ExB_sod_FT.m'); catch err, disp(getReport(err)); end;exit;"
...
for lvl=1:length(N1d)
    ...
    Nz = 1; % change this to Nx for at least 3d simulations
    %
